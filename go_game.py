...
class Environment():
	...
	def __init__(self):
		...
		self.board = self.inner_env.reset()
	...
	def step(self, a):
		...
		board, r, done, _, _ = self.inner_env.step(a)
		return board, r, done
	...
	def play_single_match(p1, p2):
		...
		tree1 = mcts.MonteCarloTreeNode(None, board, black, None)
		tree2 = mcts.MonteCarloTreeNode(None, board, black, None)
